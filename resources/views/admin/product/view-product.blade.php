        ...
        <div class="col-auto flex-grow-1 overflow-auto">
          <div class="btn-group position-static">
            <div class="btn-group position-static">
              ...
              <li><a class="dropdown-item" href="/admin/view-product">All</a></li>
              @foreach($categery as $data)
                <li><a class="dropdown-item" href="{{ route('products.index', ['category_id' => $data->id ]) }}">{{$data->name}}</a></li>
              @endforeach
              </ul>
            </div>
          </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="product-info">
                          ...
                          <p class="mb-0 product-category">Category : {{$data->category->name}}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                       @if($data->condition == 'hot')
                        <span class="badge bg-grd-danger">Hot</span>
                       @elseif($data->condition == 'new')
                      <span class="badge bg-grd-success">New</span>
                      @else
                      <span class="badge bg-grd-secondary">Default</span>
                      @endif
                    </td>
                    <td>
                       ...
                       @else
                       <span class="badge bg-grd-warning">Inactive</span>
                       @endif
                    </td>
                    <td>
                       <a href="{{ route('products.edit', $data->id) }}" class="btn btn-grd btn-grd-success">Edit</a>
