      ...
      <div class="sidebar-nav">
          ...
          <ul class="metismenu" id="sidenav">
            ...
            <li>
              ...
              <ul>
                <li><a href="/admin/add-category"><i class="material-icons-outlined">arrow_right</i>Add Category</a>
                </li>
                <li><a href="/admin/view-category"><i class="material-icons-outlined">arrow_right</i>View Category</a>
                </li>
              </ul>     
            </li>
            <li>
